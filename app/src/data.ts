...
export const STOPS = [
  ...
  { id:'s2', name:'Hotel Jakarta', kind:'Stay', icon:'bed', day:'2026-09-04', startsAt:'14:00', timeNote:'Check-in',
    ...
    documents:[{ id:'d-demo-2', name:'Hotel booking', kind:'receipt',
  ...
  { id:'s8', name:'Bikes in Vondelpark', kind:'Activity', icon:'walk', day:'2026-09-06', startsAt:'15:00', endsAt:'18:00',
