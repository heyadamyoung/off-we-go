...
export const NowCapsule = memo(function NowCapsule(
  ...
  return (
    <button className="glass absolute bottom-[var(--trip-1)] left-1/2 z-[4] flex
      ...
      <span className="flex min-w-0 items-center gap-3.5">
        <b className="truncate text-[15px] font-bold max-sm:text-[12.5px]" aria-live="polite">{text}</b>
        {meta && <>
...
export const ScopeToggle = memo(function ScopeToggle(
  ...
  return (
    ...
    <div className={'glass absolute bottom-[var(--trip-1)] z-[4] flex flex-none rounded-full p-1 ' +
      'transition-[left] max-sm:hidden ' + (shifted ? 'left-[492px] max-lg:left-4' : 'left-4')}>
...
export const MapControls = memo(function MapControls(
  ...
  const button = 'wc grid size-10 place-items-center border-b border-line text-ink last:border-b-0 ' +
