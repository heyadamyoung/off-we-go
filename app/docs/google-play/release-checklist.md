...
6. Confirm `https://wayfare.threadway.ai/.well-known/assetlinks.json` lists `ai.threadway.wayfare` and that fingerprint before testing an emailed sign-in link.
